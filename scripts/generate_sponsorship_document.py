#!/usr/bin/env python3
"""Generate a single PDF sponsorship document for Beyond Stage Zero."""

from pathlib import Path

from fpdf import FPDF

OUT = Path("/workspace/docs/BSZ-Sponsorship-Document.pdf")
ARTIFACT = Path("/opt/cursor/artifacts/BSZ-Sponsorship-Document.pdf")
...
def build():
    pdf = BriefPDF()
    pdf.set_title("Beyond Stage Zero — Sponsorship Document")
    ...
    pdf.eyebrow("Sponsorship document  ·  2026")
