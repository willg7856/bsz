...
const stages = [
  ...
  { id: 3, num: 'STAGE 03', name: 'Avionics', when: '2026-Q3', state: 'next',
    ...
    body: 'Building and qualifying Octopus — our custom flight and ground software — alongside flight computer, altimeter, GPS, and recovery electronics. Full bench integration and validation of the avionics stack before airframe integration.',
    readout: [['Octopus', 'IN BUILD'], ['Recovery sys.', 'PENDING'], ['Status', 'UPCOMING']] },
